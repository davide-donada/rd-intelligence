...
def genera_recensione_seo(prodotto):
    ...
    Regole:
    - Se sei indeciso, usa ID 9 (Tecnologia).
    - L'HTML deve includere liste puntate per Pro e Contro e il voto finale.
    """
    ...
    try:
        ...
        print(f"❌ Errore AI: {e}")
        # Fallback sicuro: HTML errore e Categoria Tecnologia (9)
